...
namespace Neo.ApplicationFramework.Generated
{
	...
	public partial class Tags : Neo.ApplicationFramework.Tools.OpcClient.GlobalController
	{
		...
		private Neo.ApplicationFramework.Tools.OpcClient.GlobalDataItem m_RS1;
		
		private Neo.ApplicationFramework.Tools.OpcClient.GlobalDataItem m_RS2;
		
		private Neo.ApplicationFramework.Tools.OpcClient.GlobalDataItem m_RS3;
		...
		public Neo.ApplicationFramework.Tools.OpcClient.GlobalDataItem RS1
		{
			get
			{
				return this.m_RS1;
		...
		public Neo.ApplicationFramework.Tools.OpcClient.GlobalDataItem RS2
		{
			get
			{
				return this.m_RS2;
		...
		public Neo.ApplicationFramework.Tools.OpcClient.GlobalDataItem RS3
		{
			get
			{
				return this.m_RS3;
		...
		private void InitializeObjectCreations()
		{
			...
			this.RS1 = new Neo.ApplicationFramework.Tools.OpcClient.GlobalDataItem("RS1", ((Neo.ApplicationFramework.Interop.DataSource.BEDATATYPE)(Neo.ApplicationFramework.Interop.DataSource.BEDATATYPE.DT_BIT)), ((short)(1)), 0D, 1D, ((short)(0)), false, "Value Change", ((Neo.ApplicationFramework.Interfaces.AccessRights)((Neo.ApplicationFramework.Interfaces.AccessRights.Read | Neo.ApplicationFramework.Interfaces.AccessRights.Write))), "PollGroup1", false, false, ((Neo.ApplicationFramework.Interop.DataSource.BEDATATYPE)(Neo.ApplicationFramework.Interop.DataSource.BEDATATYPE.DT_DEFAULT)), null, ((short)(1)));
			this.RS2 = new Neo.ApplicationFramework.Tools.OpcClient.GlobalDataItem("RS2", ((Neo.ApplicationFramework.Interop.DataSource.BEDATATYPE)(Neo.ApplicationFramework.Interop.DataSource.BEDATATYPE.DT_BIT)), ((short)(1)), 0D, 1D, ((short)(0)), false, "Value Change", ((Neo.ApplicationFramework.Interfaces.AccessRights)((Neo.ApplicationFramework.Interfaces.AccessRights.Read | Neo.ApplicationFramework.Interfaces.AccessRights.Write))), "PollGroup1", false, false, ((Neo.ApplicationFramework.Interop.DataSource.BEDATATYPE)(Neo.ApplicationFramework.Interop.DataSource.BEDATATYPE.DT_DEFAULT)), null, ((short)(1)));
			this.RS3 = new Neo.ApplicationFramework.Tools.OpcClient.GlobalDataItem("RS3", ((Neo.ApplicationFramework.Interop.DataSource.BEDATATYPE)(Neo.ApplicationFramework.Interop.DataSource.BEDATATYPE.DT_BIT)), ((short)(1)), 0D, 1D, ((short)(0)), false, "Value Change", ((Neo.ApplicationFramework.Interfaces.AccessRights)((Neo.ApplicationFramework.Interfaces.AccessRights.Read | Neo.ApplicationFramework.Interfaces.AccessRights.Write))), "PollGroup1", false, false, ((Neo.ApplicationFramework.Interop.DataSource.BEDATATYPE)(Neo.ApplicationFramework.Interop.DataSource.BEDATATYPE.DT_DEFAULT)), null, ((short)(1)));
		...
		private void InitializeObjects()
		{
			...
			this.RS.GlobalDataSubItems.Add(new Neo.ApplicationFramework.Tools.OpcClient.GlobalDataSubItem(new Neo.ApplicationFramework.Interfaces.VariantValue(""), 0, new string[] {
							"B140"}, new string[] {
							"DataItem1"}, true));
			this.RS1.GlobalDataSubItems.Add(new Neo.ApplicationFramework.Tools.OpcClient.GlobalDataSubItem(null, 0, new string[] {
							"Controller1"}, new string[] {
							"DataItem1"}, true));
			this.RS2.GlobalDataSubItems.Add(new Neo.ApplicationFramework.Tools.OpcClient.GlobalDataSubItem(null, 0, new string[] {
							"Controller2"}, new string[] {
							"DataItem1"}, true));
			this.RS3.GlobalDataSubItems.Add(new Neo.ApplicationFramework.Tools.OpcClient.GlobalDataSubItem(null, 0, new string[] {
							"Controller3"}, new string[] {
							"DataItem1"}, true));
			this.GlobalDataItems.Add(this.RS);
			this.GlobalDataItems.Add(this.RS1);
			this.GlobalDataItems.Add(this.RS2);
			this.GlobalDataItems.Add(this.RS3);
